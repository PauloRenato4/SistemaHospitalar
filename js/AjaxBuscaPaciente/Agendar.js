...
var cpf = $("#cpf").val();
        ...
        $.post('php/AgendarP.php',
               {cpf: cpf, nome: nome, sobrenome: sobrenome, rg: rg, nacionalidade: nacionalidade, email: email,
                ...
                bairro: bairro, estado: estado, cidade: cidade, cep: cep, consulta: consulta, medico: medico, validade: validade,
                timeini: timeini, timefin: timefin, checke: checke, mensagem: mensagem},
               function(data){
